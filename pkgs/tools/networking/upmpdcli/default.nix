{ fetchgit, stdenv, autoreconfHook, pkg-config, libupnpp, libnpupnp, curl, expat, mpd_clientlib, libmicrohttpd, jsoncpp
, makeWrapper, python
, recoll
, mutagen
}:
...
stdenv.mkDerivation rec {
  ...
  src = fetchgit {
    ...
    sha256 = "sha256-iKQLJw+3fCMV/X0qCjhfAjcErCzlgCPsitUE6SIzoU0=";
  };

  patches = [ ./upmpdcli-libmicrohttpd-types.patch ];
